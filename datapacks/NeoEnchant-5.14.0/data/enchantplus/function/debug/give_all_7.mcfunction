#> enchantplus:debug/give_all_7
#
# @description 커스텀 인챈트북 7번 묶음을 1레벨로 지급합니다.
#
...
give @s minecraft:enchanted_book[minecraft:stored_enchantments={"enchantplus:trident/gungnir_breath":1}]

tellraw @s [{"text":"[NeoEnchant+] 디버그 인챈트북 7/7 지급 완료 ","color":"gold"},{"text":"(1레벨, 3개)","color":"yellow"}]
